...
D=/sata2/data/rnagabhi/doom; GPU=${1:?gpu}; PY=${PY:-~/miniconda3/envs/doom/bin/python}; export TMPDIR=$D/tmp/tmpdir; mkdir -p $TMPDIR
export CUDA_VISIBLE_DEVICES=$GPU HF_HUB_OFFLINE=1
for spec in "030-dit-l32-aligned dit" "031-unet-l32-aligned unet" "033-pixart-l32-aligned pixart" "032-dit-l32-aligned-seed1 dit" "034-unidiffuser-l32-aligned unidiffuser"; do set -- $spec; RUN=$1; BB=$2; R=$D/results_spiderman/$RUN
