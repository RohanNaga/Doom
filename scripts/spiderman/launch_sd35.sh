...
COMMON="--context-frames 32 --num-actions 29 --global-batch $GLOBAL --lr 5e-5 --warmup 2000 --clip 1.0 --steps 90000 --seed 0 --action-dropout 0.0 --require-verified-transitions --latents-dir $D/latents_arnold_sd35 --split $D/split_arnold.json --val-every 1000 --val-windows 1024 --ckpt-every 5000 --snapshot-every 10000 --local-snapshots --keep-last 2 --num-workers 4 --grad-ckpt --skip-grad-norm 5 --skip-grad-after 3000 ${EXTRA:-}"
