...
| R1.4 | P0 | **Size:** Arnold set: 850 episodes x 150 s over 17 maps, about 4.2M tics and 1.05M decision frames (in progress Sep 9). Stiegler continuity set: 1,000 episodes, 4.95M tics, 1.24M decision frames, 219 GB. | `dataset_stats.py` output per set. |
