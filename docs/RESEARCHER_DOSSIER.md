...
<figure>
<div class="svg-wrap" tabindex="0"><svg viewBox="0 0 760 410" role="img" aria-label="Timeline of one training window: 32 context latents z r-32 to z r-1, each stored with its outgoing control u, where u t drives frame t to t+1; u r-1 produced the target z r and u r is future and never enters. Below, the outgoing layout stores u r-1 on row r-1 while an incoming layout stores it on row r.">
<defs><marker id="f1-a" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="currentColor"/></marker><marker id="f1-acc" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="#d0652f"/></marker></defs>
<path d="M38,48 V40 H486 V48" fill="none" stroke="currentColor" stroke-width="1.5"/>
<text x="262.0" y="32" font-size="12" text-anchor="middle" fill="currentColor">context: 32 latents, z<tspan dy="3" font-size="11">r−32</tspan><tspan dy="-3"> … z</tspan><tspan dy="3" font-size="11">r−1</tspan></text>
<text x="550" y="32" font-size="12" text-anchor="middle" fill="#d0652f" font-weight="600">target</text>
<rect x="38.0" y="58" width="64" height="42" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".06"/>
<text x="70" y="84" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−32</tspan></text>
<line x1="70" y1="100" x2="70" y2="150" stroke="currentColor" stroke-width="1.5" stroke-dasharray="2 3" opacity=".7"/>
<rect x="42" y="150" width="56" height="26" rx="13" fill="none" stroke="currentColor" stroke-width="1.5"/>
<text x="70" y="168" font-size="13" text-anchor="middle" fill="currentColor">u<tspan dy="3" font-size="11">r−32</tspan></text>
<text x="70" y="192" font-size="11" text-anchor="middle" fill="currentColor" opacity=".6">row r−32</text>
<rect x="134.0" y="58" width="64" height="42" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".06"/>
<text x="166" y="84" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−31</tspan></text>
<line x1="166" y1="100" x2="166" y2="150" stroke="currentColor" stroke-width="1.5" stroke-dasharray="2 3" opacity=".7"/>
<rect x="138" y="150" width="56" height="26" rx="13" fill="none" stroke="currentColor" stroke-width="1.5"/>
<text x="166" y="168" font-size="13" text-anchor="middle" fill="currentColor">u<tspan dy="3" font-size="11">r−31</tspan></text>
<text x="166" y="192" font-size="11" text-anchor="middle" fill="currentColor" opacity=".6">row r−31</text>
<text x="262" y="84" font-size="16" text-anchor="middle" fill="currentColor">⋯</text>
<text x="262" y="168" font-size="16" text-anchor="middle" fill="currentColor">⋯</text>
<rect x="326.0" y="58" width="64" height="42" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".06"/>
<text x="358" y="84" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−2</tspan></text>
<line x1="358" y1="100" x2="358" y2="150" stroke="currentColor" stroke-width="1.5" stroke-dasharray="2 3" opacity=".7"/>
<rect x="330" y="150" width="56" height="26" rx="13" fill="none" stroke="currentColor" stroke-width="1.5"/>
<text x="358" y="168" font-size="13" text-anchor="middle" fill="currentColor">u<tspan dy="3" font-size="11">r−2</tspan></text>
<text x="358" y="192" font-size="11" text-anchor="middle" fill="currentColor" opacity=".6">row r−2</text>
<rect x="422.0" y="58" width="64" height="42" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".06"/>
<text x="454" y="84" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<line x1="454" y1="100" x2="454" y2="150" stroke="currentColor" stroke-width="1.5" stroke-dasharray="2 3" opacity=".7"/>
<rect x="426" y="150" width="56" height="26" rx="13" fill="none" stroke="#d0652f" stroke-width="2"/>
<text x="454" y="168" font-size="13" text-anchor="middle" fill="#d0652f" font-weight="600">u<tspan dy="3" font-size="11">r−1</tspan></text>
<text x="454" y="192" font-size="11" text-anchor="middle" fill="currentColor" opacity=".6">row r−1</text>
<rect x="518.0" y="58" width="64" height="42" rx="4" fill="#d0652f" stroke="#d0652f" stroke-width="2" fill-opacity=".12"/>
<text x="550" y="84" font-size="13" text-anchor="middle" fill="#d0652f" font-weight="600">z<tspan dy="3" font-size="11">r</tspan></text>
<line x1="550" y1="100" x2="550" y2="150" stroke="currentColor" stroke-width="1.5" stroke-dasharray="2 3" opacity=".55"/>
<rect x="522" y="150" width="56" height="26" rx="13" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 3" opacity=".55"/>
<text x="550" y="168" font-size="13" text-anchor="middle" fill="currentColor" opacity=".55">u<tspan dy="3" font-size="11">r</tspan></text>
<text x="550" y="192" font-size="11" text-anchor="middle" fill="currentColor" opacity=".6">row r</text>
<rect x="614.0" y="58" width="64" height="42" rx="4" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 3" opacity=".55"/>
<text x="646" y="84" font-size="13" text-anchor="middle" fill="currentColor" opacity=".55">z<tspan dy="3" font-size="11">r+1</tspan></text>
<line x1="98" y1="152" x2="140.0" y2="104" stroke="currentColor" stroke-width="1.5" marker-end="url(#f1-a)" opacity=".8"/>
<line x1="194" y1="152" x2="256" y2="94" stroke="currentColor" stroke-width="1.5" marker-end="url(#f1-a)" opacity=".8"/>
<line x1="274" y1="154" x2="332.0" y2="104" stroke="currentColor" stroke-width="1.5" marker-end="url(#f1-a)" opacity=".8"/>
<line x1="386" y1="152" x2="428.0" y2="104" stroke="currentColor" stroke-width="1.5" marker-end="url(#f1-a)" opacity=".8"/>
<line x1="482" y1="152" x2="524.0" y2="104" stroke="#d0652f" stroke-width="2" marker-end="url(#f1-acc)"/>
<line x1="578" y1="152" x2="620.0" y2="104" stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 3" marker-end="url(#f1-a)" opacity=".55"/>
<text x="70" y="210" font-size="12" text-anchor="middle" fill="currentColor">u<tspan dy="3" font-size="11">t</tspan><tspan dy="-3"> drives t → t+1</tspan></text>
<text x="454" y="210" font-size="12" text-anchor="middle" fill="#d0652f" font-weight="600">produced z<tspan dy="3" font-size="11">r</tspan></text>
<text x="550" y="210" font-size="12" text-anchor="middle" fill="currentColor" opacity=".7">never an input</text>
<path d="M38,222 V230 H486 V222" fill="none" stroke="currentColor" stroke-width="1.5"/>
<text x="262.0" y="248" font-size="12" text-anchor="middle" fill="currentColor">conditioning: 32 executed controls, u<tspan dy="3" font-size="11">r−32</tspan><tspan dy="-3"> … u</tspan><tspan dy="3" font-size="11">r−1</tspan></text>
<line x1="20" y1="276" x2="740" y2="276" stroke="currentColor" stroke-width="1" opacity=".3"/>
<text x="20" y="296" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">Where the control that produced z<tspan dy="3" font-size="11">r</tspan><tspan dy="-3"> is stored</tspan></text>
<text x="330" y="320" font-size="11" text-anchor="middle" fill="currentColor" opacity=".7">row r−1</text>
<text x="470" y="320" font-size="11" text-anchor="middle" fill="currentColor" opacity=".7">row r</text>
<text x="20" y="351" font-size="12" text-anchor="start" fill="currentColor">outgoing (ours)</text>
<rect x="268" y="330" width="124" height="32" rx="4" fill="currentColor" stroke="#d0652f" stroke-width="2" fill-opacity=".04"/>
<text x="304" y="351" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<text x="356" y="351" font-size="13" text-anchor="middle" fill="#d0652f" font-weight="600">u<tspan dy="3" font-size="11">r−1</tspan></text>
<rect x="408" y="330" width="124" height="32" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1" fill-opacity=".04"/>
<text x="444" y="351" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r</tspan></text>
<text x="496" y="351" font-size="13" text-anchor="middle" fill="currentColor">u<tspan dy="3" font-size="11">r</tspan></text>
<text x="20" y="391" font-size="12" text-anchor="start" fill="currentColor">incoming (other datasets)</text>
<rect x="268" y="370" width="124" height="32" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1" fill-opacity=".04"/>
<text x="304" y="391" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<text x="356" y="391" font-size="13" text-anchor="middle" fill="currentColor">u<tspan dy="3" font-size="11">r−2</tspan></text>
<rect x="408" y="370" width="124" height="32" rx="4" fill="currentColor" stroke="#d0652f" stroke-width="2" fill-opacity=".04"/>
<text x="444" y="391" font-size="13" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r</tspan></text>
<text x="496" y="391" font-size="13" text-anchor="middle" fill="#d0652f" font-weight="600">u<tspan dy="3" font-size="11">r−1</tspan></text>
<text x="560" y="348" font-size="12" text-anchor="start" fill="currentColor">same control, one row apart:</text>
<text x="560" y="364" font-size="12" text-anchor="start" fill="currentColor">reading one layout with the</text>
<text x="560" y="380" font-size="12" text-anchor="start" fill="currentColor">other's offsets shifts every</text>
<text x="560" y="396" font-size="12" text-anchor="start" fill="currentColor">control by one tic</text>
</svg></div>
<figcaption>One window of the task p(z<sub>r</sub> | z<sub>r−32:r</sub>, u<sub>r−32:r</sub>): each control is stored on the row of the frame it was applied from, so the last conditioning control u<sub>r−1</sub> is the one that produced the target, and u<sub>r</sub> never enters.</figcaption>
</figure>
...
<figure>
<div class="svg-wrap" tabindex="0"><svg viewBox="0 0 760 444" role="img" aria-label="Three evaluation protocols on one window, sharing the last real frame. Teacher-forced h1 predicts one frame from 32 real frames; h4 feeds its own three predictions back and is scored at the fourth. The 256-tic rollout feeds every prediction back as the newest context frame and is scored at 4, 32, 64, 128 and 256 tics against copy-seed, which holds the last real frame. The directional check predicts the same window twice with TURN_LEFT and TURN_RIGHT swapped in the newest control and measures the horizontal shift of each prediction.">
<defs><marker id="f4-a" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="currentColor"/></marker><marker id="f4-acc" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="#d0652f"/></marker></defs>
<line x1="304" y1="20" x2="304" y2="436" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 3" opacity=".5"/>
<text x="308" y="20" font-size="11" text-anchor="start" fill="currentColor" opacity=".7">last real frame</text>
<text x="20" y="69" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">teacher-forced h1</text>
<rect x="150" y="52" width="118" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1" fill-opacity=".08"/>
<text x="209.0" y="68" font-size="11" text-anchor="middle" fill="currentColor">32 real frames</text>
<rect x="276" y="52" width="24" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".08"/>
<text x="288.0" y="94" font-size="11" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<rect x="312" y="52" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="324.0" y="94" font-size="11" text-anchor="middle" fill="#d0652f">ẑ<tspan dy="3" font-size="11">r</tspan></text>
<text x="348" y="69" font-size="12" text-anchor="start" fill="currentColor">scored against real z<tspan dy="3" font-size="11">r</tspan><tspan dy="-3">; persistence copies z</tspan><tspan dy="3" font-size="11">r−1</tspan></text>
<text x="20" y="141" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">teacher-forced h4</text>
<rect x="150" y="124" width="118" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1" fill-opacity=".08"/>
<text x="209.0" y="140" font-size="11" text-anchor="middle" fill="currentColor">32 real frames</text>
<rect x="276" y="124" width="24" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".08"/>
<text x="288.0" y="166" font-size="11" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<rect x="312" y="124" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="324.0" y="166" font-size="11" text-anchor="middle" fill="#d0652f">ẑ<tspan dy="3" font-size="11">r</tspan></text>
<rect x="344" y="124" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="356.0" y="166" font-size="11" text-anchor="middle" fill="#d0652f">ẑ<tspan dy="3" font-size="11">r+1</tspan></text>
<path d="M324.0,124 C324.0,108 354.0,108 354.0,122" fill="none" stroke="#d0652f" stroke-width="1.3" marker-end="url(#f4-acc)"/>
<rect x="376" y="124" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="388.0" y="166" font-size="11" text-anchor="middle" fill="#d0652f">ẑ<tspan dy="3" font-size="11">r+2</tspan></text>
<path d="M356.0,124 C356.0,108 386.0,108 386.0,122" fill="none" stroke="#d0652f" stroke-width="1.3" marker-end="url(#f4-acc)"/>
<rect x="408" y="124" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="420.0" y="166" font-size="11" text-anchor="middle" fill="#d0652f">ẑ<tspan dy="3" font-size="11">r+3</tspan></text>
<path d="M388.0,124 C388.0,108 418.0,108 418.0,122" fill="none" stroke="#d0652f" stroke-width="1.3" marker-end="url(#f4-acc)"/>
<text x="444" y="141" font-size="12" text-anchor="start" fill="currentColor">3 predictions fed back; scored at z<tspan dy="3" font-size="11">r+3</tspan></text>
<text x="20" y="231" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">256-tic rollout</text>
<rect x="150" y="214" width="118" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1" fill-opacity=".08"/>
<text x="209.0" y="230" font-size="11" text-anchor="middle" fill="currentColor">32 real seed frames</text>
<rect x="276" y="214" width="24" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".08"/>
<text x="288.0" y="256" font-size="11" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<rect x="312" y="214" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<rect x="344" y="214" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<path d="M324.0,214 C324.0,198 354.0,198 354.0,212" fill="none" stroke="#d0652f" stroke-width="1.3" marker-end="url(#f4-acc)"/>
<rect x="376" y="214" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<path d="M356.0,214 C356.0,198 386.0,198 386.0,212" fill="none" stroke="#d0652f" stroke-width="1.3" marker-end="url(#f4-acc)"/>
<rect x="408" y="214" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<path d="M388.0,214 C388.0,198 418.0,198 418.0,212" fill="none" stroke="#d0652f" stroke-width="1.3" marker-end="url(#f4-acc)"/>
<text x="452.0" y="232" font-size="14" text-anchor="middle" fill="#d0652f">⋯</text>
<rect x="472" y="214" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="516.0" y="232" font-size="14" text-anchor="middle" fill="#d0652f">⋯</text>
<rect x="536" y="214" width="24" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<text x="572" y="224" font-size="12" text-anchor="start" fill="currentColor">fed back as newest context;</text>
<text x="572" y="239" font-size="12" text-anchor="start" fill="currentColor">oldest frame drops out</text>
<text x="420.0" y="256" font-size="11" text-anchor="middle" fill="#d0652f">4</text>
<text x="548.0" y="256" font-size="11" text-anchor="middle" fill="#d0652f">256</text>
<text x="484.0" y="256" font-size="11" text-anchor="middle" fill="#d0652f">32, 64, 128</text>
<text x="20" y="289" font-size="12" text-anchor="start" fill="currentColor">copy-seed</text>
<text x="20" y="303" font-size="12" text-anchor="start" fill="currentColor">reference</text>
<rect x="276" y="272" width="24" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".08"/>
<rect x="312" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="344" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="376" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="408" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="440" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="472" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="504" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<rect x="536" y="272" width="24" height="24" rx="2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 2" opacity=".6"/>
<line x1="288.0" y1="302" x2="548.0" y2="302" stroke="currentColor" stroke-width="1" marker-end="url(#f4-a)" opacity=".7"/>
<text x="572" y="289" font-size="12" text-anchor="start" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan><tspan dy="-3"> held throughout</tspan></text>
<text x="20" y="369" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">directional check</text>
<text x="20" y="385" font-size="11" text-anchor="start" fill="currentColor" opacity=".75">64 windows per turn;</text>
<text x="20" y="399" font-size="11" text-anchor="start" fill="currentColor" opacity=".75">reversed in 87% (U-Net)</text>
<text x="20" y="413" font-size="11" text-anchor="start" fill="currentColor" opacity=".75">and 84% (SD 3.5 EMA)</text>
<rect x="150" y="364" width="118" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1" fill-opacity=".08"/>
<text x="209.0" y="380" font-size="11" text-anchor="middle" fill="currentColor">32 real frames</text>
<rect x="276" y="364" width="24" height="24" rx="2" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".08"/>
<text x="288.0" y="406" font-size="11" text-anchor="middle" fill="currentColor">z<tspan dy="3" font-size="11">r−1</tspan></text>
<path d="M302,376 L436,365" fill="none" stroke="currentColor" stroke-width="1.2" marker-end="url(#f4-a)" opacity=".8"/>
<text x="316" y="349" font-size="11" text-anchor="start" fill="currentColor" opacity=".8">newest control TURN_LEFT</text>
<rect x="442" y="352" width="40" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<line x1="450" y1="365" x2="474" y2="365" stroke="#d0652f" stroke-width="2" marker-end="url(#f4-acc)"/>
<text x="494" y="369" font-size="12" text-anchor="start" fill="currentColor">should slide right: true median +18.2 px</text>
<path d="M302,376 L436,409" fill="none" stroke="currentColor" stroke-width="1.2" marker-end="url(#f4-a)" opacity=".8"/>
<text x="316" y="434" font-size="11" text-anchor="start" fill="currentColor" opacity=".8">newest control TURN_RIGHT, swapped</text>
<rect x="442" y="396" width="40" height="24" rx="2" fill="#d0652f" stroke="#d0652f" stroke-width="1.5" fill-opacity=".15"/>
<line x1="474" y1="409" x2="450" y2="409" stroke="#d0652f" stroke-width="2" marker-end="url(#f4-acc)"/>
<text x="494" y="413" font-size="12" text-anchor="start" fill="currentColor">should slide left: true median −19.1 px</text>
</svg></div>
<figcaption>The instruments differ only in what feeds the context after the last real frame: nothing (h1), three of the model's own predictions (h4), all 255 of them (rollout, against a frozen copy of the seed), or the same real context under a swapped newest control (directional check).</figcaption>
</figure>
...
`rollout_eval.py` runs 16 rollouts of 256 tics from validation episodes with the recorded executed controls, clean context and 10-step DDIM, feeding each predicted latent back as context. It scores raw frames at 4, 32, 64, 128 and 256 tics. Seed 0 draws the standing windows. Seed 1 draws a second set, run on the EMA at 105k and at every read from 115k, and on the live weights at 50k and 70k. Seed 2 is the backfill on surviving snapshots. Every full read keeps the rollout arrays (`npz`), so events can be counted after the fact. [RC 09-26 03:30, 09:00]
...
<figure>
<div class="svg-wrap" tabindex="0"><svg viewBox="0 0 760 344" role="img" aria-label="Left: schematic traces of the per-frame mean of SD 3.5 latent channel 13 over a 256-tic rollout. A healthy rollout wanders near +0.45 inside the real-data range of -0.44 to 0.80; a captured rollout leaves the range and settles at about -1.45, below the event line at -0.9, and never returns; a second fixed value sits at -2.60 to -2.73. Right: the closed loop that holds it there: the shifted prediction is appended to the context, the context conditions the model, and the model predicts the same shift again.">
<defs><marker id="f5-a" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="currentColor"/></marker><marker id="f5-acc" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="#d0652f"/></marker></defs>
<rect x="70" y="43.0" width="360" height="80.6" rx="0" fill="currentColor" stroke="currentColor" stroke-width="0" fill-opacity=".08"/>
<text x="424" y="117.6" font-size="11" text-anchor="end" fill="currentColor" opacity=".75">range in real footage, −0.44 to 0.80</text>
<line x1="70" y1="153.5" x2="430" y2="153.5" stroke="currentColor" stroke-width="1" stroke-dasharray="5 4" opacity=".7"/>
<text x="424" y="148.5" font-size="11" text-anchor="end" fill="currentColor" opacity=".75">event (c) line, −0.9</text>
<line x1="70" y1="30" x2="70" y2="290" stroke="currentColor" stroke-width="1"/>
<line x1="70" y1="290" x2="430" y2="290" stroke="currentColor" stroke-width="1"/>
<line x1="66" y1="30.0" x2="70" y2="30.0" stroke="currentColor" stroke-width="1"/>
<text x="62" y="34.0" font-size="11" text-anchor="end" fill="currentColor">+1</text>
<line x1="66" y1="95.0" x2="70" y2="95.0" stroke="currentColor" stroke-width="1"/>
<text x="62" y="99.0" font-size="11" text-anchor="end" fill="currentColor">0</text>
<line x1="66" y1="160.0" x2="70" y2="160.0" stroke="currentColor" stroke-width="1"/>
<text x="62" y="164.0" font-size="11" text-anchor="end" fill="currentColor">-1</text>
<line x1="66" y1="225.0" x2="70" y2="225.0" stroke="currentColor" stroke-width="1"/>
<text x="62" y="229.0" font-size="11" text-anchor="end" fill="currentColor">-2</text>
<line x1="66" y1="290.0" x2="70" y2="290.0" stroke="currentColor" stroke-width="1"/>
<text x="62" y="294.0" font-size="11" text-anchor="end" fill="currentColor">-3</text>
<line x1="70.0" y1="290" x2="70.0" y2="294" stroke="currentColor" stroke-width="1"/>
<text x="70.0" y="307" font-size="11" text-anchor="middle" fill="currentColor">0</text>
<line x1="160.0" y1="290" x2="160.0" y2="294" stroke="currentColor" stroke-width="1"/>
<text x="160.0" y="307" font-size="11" text-anchor="middle" fill="currentColor">64</text>
<line x1="250.0" y1="290" x2="250.0" y2="294" stroke="currentColor" stroke-width="1"/>
<text x="250.0" y="307" font-size="11" text-anchor="middle" fill="currentColor">128</text>
<line x1="340.0" y1="290" x2="340.0" y2="294" stroke="currentColor" stroke-width="1"/>
<text x="340.0" y="307" font-size="11" text-anchor="middle" fill="currentColor">192</text>
<line x1="430.0" y1="290" x2="430.0" y2="294" stroke="currentColor" stroke-width="1"/>
<text x="430.0" y="307" font-size="11" text-anchor="middle" fill="currentColor">256</text>
<text x="250.0" y="324" font-size="12" text-anchor="middle" fill="currentColor">rollout tic</text>
<text x="18" y="160.0" font-size="12" text-anchor="middle" fill="currentColor" transform="rotate(-90 18 160.0)">channel 13, per-frame mean</text>
<path d="M70.0,61.9 L72.8,59.4 L75.6,58.7 L78.4,59.6 L81.2,61.1 L84.1,62.2 L86.9,62.0 L89.7,60.5 L92.5,58.0 L95.3,55.8 L98.1,54.8 L100.9,55.9 L103.8,59.0 L106.6,63.5 L109.4,68.1 L112.2,71.7 L115.0,73.5 L117.8,73.3 L120.6,71.9 L123.4,70.3 L126.2,69.5 L129.1,70.0 L131.9,71.8 L134.7,74.1 L137.5,75.8 L140.3,75.9 L143.1,73.8 L145.9,70.0 L148.8,65.3 L151.6,60.9 L154.4,58.0 L157.2,57.1 L160.0,58.0 L162.8,59.8 L165.6,61.4 L168.4,61.9 L171.2,61.0 L174.1,59.0 L176.9,57.0 L179.7,56.0 L182.5,56.9 L185.3,59.8 L188.1,64.2 L190.9,68.9 L193.8,72.8 L196.6,74.8 L199.4,74.9 L202.2,73.4 L205.0,71.4 L207.8,69.9 L210.6,69.8 L213.4,71.0 L216.2,72.9 L219.1,74.4 L221.9,74.6 L224.7,72.9 L227.5,69.2 L230.3,64.6 L233.1,60.1 L235.9,56.9 L238.8,55.8 L241.6,56.6 L244.4,58.6 L247.2,60.7 L250.0,61.8 L252.8,61.6 L255.6,60.2 L258.4,58.5 L261.2,57.5 L264.1,58.1 L266.9,60.7 L269.7,64.9 L272.5,69.6 L275.3,73.7 L278.1,76.0 L280.9,76.2 L283.8,74.6 L286.6,72.3 L289.4,70.2 L292.2,69.4 L295.0,69.9 L297.8,71.4 L300.6,72.9 L303.4,73.2 L306.2,71.7 L309.1,68.4 L311.9,63.9 L314.7,59.3 L317.5,56.0 L320.3,54.6 L323.1,55.4 L325.9,57.6 L328.8,60.1 L331.6,62.0 L334.4,62.4 L337.2,61.6 L340.0,60.1 L342.8,59.1 L345.6,59.5 L348.4,61.8 L351.2,65.7 L354.1,70.3 L356.9,74.4 L359.7,76.9 L362.5,77.2 L365.3,75.6 L368.1,73.0 L370.9,70.4 L373.8,68.9 L376.6,68.8 L379.4,69.8 L382.2,71.1 L385.0,71.6 L387.8,70.5 L390.6,67.5 L393.4,63.2 L396.2,58.7 L399.1,55.3 L401.9,53.8 L404.7,54.4 L407.5,56.8 L410.3,59.7 L413.1,62.2 L415.9,63.3 L418.8,63.1 L421.6,61.9 L424.4,60.9 L427.2,61.0 L430.0,62.9" fill="none" stroke="currentColor" stroke-width="1.8"/>
<text x="345.625" y="37.0" font-size="12" text-anchor="middle" fill="currentColor">healthy rollout</text>
<path d="M70.0,65.8 L72.8,63.9 L75.6,62.2 L78.4,60.8 L81.2,59.8 L84.1,59.3 L86.9,59.3 L89.7,59.8 L92.5,60.8 L95.3,62.2 L98.1,63.9 L100.9,65.8 L103.8,67.6 L106.6,69.3 L109.4,70.7 L112.2,71.7 L115.0,72.2 L117.8,72.2 L120.6,71.7 L123.4,70.7 L126.2,69.3 L129.1,68.8 L131.9,70.4 L134.7,74.1 L137.5,79.8 L140.3,87.5 L143.1,97.1 L145.9,108.0 L148.8,119.2 L151.6,130.2 L154.4,140.9 L157.2,151.6 L160.0,162.4 L162.8,172.6 L165.6,180.9 L168.4,186.2 L171.2,188.3 L174.1,187.9 L176.9,187.3 L179.7,188.1 L182.5,189.7 L185.3,191.0 L188.1,191.1 L190.9,189.8 L193.8,188.2 L196.6,187.3 L199.4,187.8 L202.2,189.3 L205.0,190.8 L207.8,191.2 L210.6,190.2 L213.4,188.6 L216.2,187.4 L219.1,187.6 L221.9,188.9 L224.7,190.5 L227.5,191.2 L230.3,190.5 L233.1,188.9 L235.9,187.6 L238.8,187.4 L241.6,188.6 L244.4,190.2 L247.2,191.2 L250.0,190.8 L252.8,189.3 L255.6,187.8 L258.4,187.3 L261.2,188.2 L264.1,189.8 L266.9,191.1 L269.7,191.0 L272.5,189.7 L275.3,188.1 L278.1,187.3 L280.9,187.9 L283.8,189.5 L286.6,190.9 L289.4,191.1 L292.2,190.0 L295.0,188.4 L297.8,187.4 L300.6,187.7 L303.4,189.1 L306.2,190.6 L309.1,191.2 L311.9,190.4 L314.7,188.8 L317.5,187.5 L320.3,187.5 L323.1,188.7 L325.9,190.3 L328.8,191.2 L331.6,190.7 L334.4,189.1 L337.2,187.7 L340.0,187.3 L342.8,188.4 L345.6,190.0 L348.4,191.1 L351.2,190.9 L354.1,189.5 L356.9,187.9 L359.7,187.3 L362.5,188.0 L365.3,189.6 L368.1,191.0 L370.9,191.1 L373.8,189.9 L376.6,188.3 L379.4,187.3 L382.2,187.8 L385.0,189.3 L387.8,190.7 L390.6,191.2 L393.4,190.2 L396.2,188.6 L399.1,187.4 L401.9,187.5 L404.7,188.9 L407.5,190.5 L410.3,191.2 L413.1,190.5 L415.9,189.0 L418.8,187.6 L421.6,187.4 L424.4,188.5 L427.2,190.1 L430.0,191.2" fill="none" stroke="#d0652f" stroke-width="2.2"/>
<circle cx="430.0" cy="189.25" r="5" fill="none" stroke="#d0652f" stroke-width="2"/>
<text x="280.9375" y="211.25" font-size="12" text-anchor="middle" fill="#d0652f" font-weight="600">captured: settles at −1.39 to −1.50</text>
<text x="280.9375" y="226.25" font-size="11" text-anchor="middle" fill="#d0652f">and never returns (17 of 22 collapses)</text>
<line x1="70" y1="267.25" x2="430" y2="267.25" stroke="currentColor" stroke-width="1" stroke-dasharray="1 3" opacity=".7"/>
<text x="424" y="262.25" font-size="11" text-anchor="end" fill="currentColor" opacity=".75">second fixed value, −2.60 to −2.73 (4 of 22)</text>
<rect x="558" y="32" width="124" height="40" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".05"/>
<text x="620" y="49" font-size="11" text-anchor="middle" fill="currentColor">32-frame context</text>
<text x="620" y="63" font-size="11" text-anchor="middle" fill="currentColor">(newest frame shifted)</text>
<rect x="628" y="190" width="124" height="40" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".05"/>
<text x="690" y="207" font-size="11" text-anchor="middle" fill="currentColor">model predicts</text>
<text x="690" y="221" font-size="11" text-anchor="middle" fill="currentColor">the next latent</text>
<rect x="468" y="190" width="124" height="40" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".05"/>
<text x="530" y="207" font-size="11" text-anchor="middle" fill="currentColor">prediction: ch 13</text>
<text x="530" y="221" font-size="11" text-anchor="middle" fill="currentColor">mean ≈ −1.4 again</text>
<path d="M682,52 Q706,52 706,188" fill="none" stroke="#d0652f" stroke-width="1.8" marker-end="url(#f5-acc)"/>
<path d="M628,210 L594,210" fill="none" stroke="#d0652f" stroke-width="1.8" marker-end="url(#f5-acc)"/>
<path d="M514,190 Q514,52 556,52" fill="none" stroke="#d0652f" stroke-width="1.8" marker-end="url(#f5-acc)"/>
<text x="696" y="108" font-size="11" text-anchor="end" fill="currentColor">conditions</text>
<text x="610" y="238" font-size="11" text-anchor="middle" fill="currentColor">predicts</text>
<text x="532" y="100" font-size="11" text-anchor="start" fill="currentColor">appended as</text>
<text x="532" y="114" font-size="11" text-anchor="start" fill="currentColor">newest frame</text>
<text x="612" y="146" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">fixed point: a shifted</text>
<text x="612" y="160" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">context yields the</text>
<text x="612" y="174" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">same shift again</text>
<text x="610" y="272" font-size="11" text-anchor="middle" fill="currentColor" opacity=".75">latent RMS stays 0.98 to 1.19, inside the</text>
<text x="610" y="286" font-size="11" text-anchor="middle" fill="currentColor" opacity=".75">real range: one channel's mean is wrong,</text>
<text x="610" y="300" font-size="11" text-anchor="middle" fill="currentColor" opacity=".75">nothing explodes</text>
</svg></div>
<figcaption>The absorbing state: once a prediction with channel 13 shifted enters the context, the model reproduces the shift, so the closed loop has a fixed point at about −1.4 (traces schematic, levels as measured in this section).</figcaption>
</figure>
...
On the standing windows the EMA rate is flat, and the live rate falls to meet it; without the 70k collapse the early live seed-0 rate is 7 of 144 (4.9 percent), so it too is roughly flat outside the collapse checkpoints. On the same seed-0 windows over the same 16 reads from 55k to 130k, the live weights have 23 / 17 / 14 events (a) / (b) / (c) of 256 rollouts and the EMA 9 / 4 / 4; without the 70k read, 11 / 6 / 4 against 8 / 3 / 4 of 240. So the live-versus-EMA gap is concentrated at the 50k and 70k collapses, and the late rise in the pooled EMA rate comes from the harder seed-1 windows, mostly on maps 4 and 5. Whether stability truly declines late in training is not yet tested: that needs the same windows run at early and late checkpoints. The seed-2 backfill (90k already, then 100k, 110k, 120k and 125k) can answer it on its own windows. [RC 09-26 09:00]
...
<figure>
<div class="svg-wrap" tabindex="0"><svg viewBox="0 0 760 404" role="img" aria-label="Distance-study pipeline. Reference lane: for each training map, 50 training episodes, 250 frames each stratified by motion decile, form a 12,500-point cloud of 192-dimensional pooled latents; a second disjoint draw gives 40 train-versus-train distances, the floor band 0.022 to 0.093. Distance lane: for each evaluation map, 4 episodes times 250 frames form a 1,000-point motion-weighted cloud; its sliced Wasserstein distance to each of the four reference clouds is taken, the minimum picks the nearest training map, and the mean over ten 4-episode subsets is D(m). Outcome lane: 256 windows of the same map give the gain over persistence; D and gain meet only at the map, over 30 maps, in a partial Spearman correlation of -0.73.">
<defs><marker id="f6-a" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="currentColor"/></marker><marker id="f6-acc" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="#d0652f"/></marker></defs>
<text x="20" y="20" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">reference: each training map k (arenas 2 to 5)</text>
<text x="20" y="124" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">distance: each evaluation map m (30 maps)</text>
<text x="20" y="326" font-size="12" text-anchor="start" fill="currentColor" font-weight="600">outcome: the same map m</text>
<rect x="20" y="32" width="132" height="52" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="86.0" y="55.0" font-size="11" text-anchor="middle" fill="currentColor">50 training episodes</text>
<text x="86.0" y="69.0" font-size="11" text-anchor="middle" fill="currentColor">(ids 0:2000)</text>
<rect x="172" y="32" width="132" height="52" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="238.0" y="55.0" font-size="11" text-anchor="middle" fill="currentColor">250 frames each,</text>
<text x="238.0" y="69.0" font-size="11" text-anchor="middle" fill="currentColor">25 per motion decile</text>
<rect x="324" y="32" width="132" height="52" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="390.0" y="55.0" font-size="11" text-anchor="middle" fill="currentColor">reference cloud k:</text>
<text x="390.0" y="69.0" font-size="11" text-anchor="middle" fill="currentColor">12,500 × 192-d</text>
<rect x="628" y="32" width="132" height="52" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04" stroke-dasharray="4 3"/>
<text x="694.0" y="55.0" font-size="11" text-anchor="middle" fill="currentColor">floor: 40 train-vs-train</text>
<text x="694.0" y="69.0" font-size="11" text-anchor="middle" fill="currentColor">SW₂ = 0.022 to 0.093</text>
<line x1="152" y1="58.0" x2="170" y2="58.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="304" y1="58.0" x2="322" y2="58.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="456" y1="58.0" x2="626" y2="58.0" stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 3" marker-end="url(#f6-a)"/>
<text x="542.0" y="52.0" font-size="11" text-anchor="middle" fill="currentColor" opacity=".75">second disjoint draw</text>
<rect x="20" y="136" width="132" height="60" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="86.0" y="163.0" font-size="11" text-anchor="middle" fill="currentColor">4 episodes of map m</text>
<text x="86.0" y="177.0" font-size="11" text-anchor="middle" fill="currentColor">(one subset)</text>
<rect x="172" y="136" width="132" height="60" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="238.0" y="156.0" font-size="11" text-anchor="middle" fill="currentColor">250 eligible frames</text>
<text x="238.0" y="170.0" font-size="11" text-anchor="middle" fill="currentColor">each, 25 per</text>
<text x="238.0" y="184.0" font-size="11" text-anchor="middle" fill="currentColor">motion decile</text>
<rect x="324" y="136" width="132" height="60" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="390.0" y="156.0" font-size="11" text-anchor="middle" fill="currentColor">cloud m: 1,000 × 192-d</text>
<text x="390.0" y="170.0" font-size="11" text-anchor="middle" fill="currentColor">pooled SD 1.x latents,</text>
<text x="390.0" y="184.0" font-size="11" text-anchor="middle" fill="currentColor">motion weights</text>
<rect x="476" y="136" width="132" height="60" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="542.0" y="156.0" font-size="11" text-anchor="middle" fill="currentColor">SW₂ to each of the</text>
<text x="542.0" y="170.0" font-size="11" text-anchor="middle" fill="currentColor">4 reference clouds,</text>
<text x="542.0" y="184.0" font-size="11" text-anchor="middle" fill="currentColor">1,000 directions</text>
<rect x="628" y="136" width="132" height="60" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="694.0" y="163.0" font-size="11" text-anchor="middle" fill="currentColor">min over k:</text>
<text x="694.0" y="177.0" font-size="11" text-anchor="middle" fill="currentColor">nearest training map</text>
<line x1="152" y1="166.0" x2="170" y2="166.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="304" y1="166.0" x2="322" y2="166.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="456" y1="166.0" x2="474" y2="166.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="608" y1="166.0" x2="626" y2="166.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<path d="M390.0,84 V104 H542.0 V134" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<text x="548.0" y="118" font-size="11" text-anchor="start" fill="currentColor" opacity=".75">4 references</text>
<path d="M694.0,196 V224" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<rect x="628" y="226" width="132" height="60" rx="4" fill="currentColor" stroke="#d0652f" stroke-width="2" fill-opacity=".04"/>
<text x="694.0" y="246.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">D(m): mean over ten</text>
<text x="694.0" y="260.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">4-episode subsets</text>
<text x="694.0" y="274.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">(maps with more than 4)</text>
<path d="M628,252.0 H86.0 V198" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3 3" marker-end="url(#f6-a)" opacity=".6"/>
<text x="364.0" y="246.0" font-size="11" text-anchor="middle" fill="currentColor" opacity=".7">redraw the 4 episodes, ten times</text>
<rect x="20" y="338" width="132" height="52" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="86.0" y="361.0" font-size="11" text-anchor="middle" fill="currentColor">256 windows of map m</text>
<text x="86.0" y="375.0" font-size="11" text-anchor="middle" fill="currentColor">(eval_tf draw)</text>
<rect x="172" y="338" width="132" height="52" rx="4" fill="currentColor" stroke="currentColor" stroke-width="1.5" fill-opacity=".04"/>
<text x="238.0" y="361.0" font-size="11" text-anchor="middle" fill="currentColor">U-Net 200k EMA,</text>
<text x="238.0" y="375.0" font-size="11" text-anchor="middle" fill="currentColor">h1, 10-step DDIM</text>
<rect x="324" y="338" width="132" height="52" rx="4" fill="currentColor" stroke="#d0652f" stroke-width="2" fill-opacity=".04"/>
<text x="390.0" y="361.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">gain(m): mean PSNR</text>
<text x="390.0" y="375.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">minus persistence</text>
<rect x="628" y="338" width="132" height="60" rx="4" fill="currentColor" stroke="#d0652f" stroke-width="2" fill-opacity=".04"/>
<text x="694.0" y="358.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">30 maps (D, gain):</text>
<text x="694.0" y="372.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">partial Spearman</text>
<text x="694.0" y="386.0" font-size="11" text-anchor="middle" fill="#d0652f" font-weight="600">ρ = −0.73</text>
<line x1="152" y1="364.0" x2="170" y2="364.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="304" y1="364.0" x2="322" y2="364.0" stroke="currentColor" stroke-width="1.5" marker-end="url(#f6-a)"/>
<line x1="456" y1="364.0" x2="626" y2="364.0" stroke="#d0652f" stroke-width="2" marker-end="url(#f6-acc)"/>
<line x1="694.0" y1="286" x2="694.0" y2="336" stroke="#d0652f" stroke-width="2" marker-end="url(#f6-acc)"/>
<text x="542.0" y="358.0" font-size="11" text-anchor="middle" fill="#d0652f">joined only by map</text>
</svg></div>
<figcaption>The distance never sees the model and the outcome never sees the distance: each map contributes one D from footage alone and one gain from 256 scored windows, and the two meet only in the 30-map correlation.</figcaption>
</figure>
...
**Uncertainty.** A **case bootstrap** resamples the 30 maps with replacement (and episodes within each map) 10,000 times and recomputes ρ; the middle 95 percent is the CI. A **permutation test** shuffles gains across maps 10,000 times; p is the share of shuffles with |ρ| at least the observed one, so 0.0001 is 1/10,001, the floor. **Leave-one-map-out** refits the primary 30 times with one map removed; the sign must hold in every refit, so no single map carries the result. Noise in a predictor shrinks any correlation with it toward zero (regression dilution), so distance uncertainty is measured from 200 episode redraws: if D's bootstrap SD is under a tenth of its spread across maps (the attenuation ratio), a correlation with D is attenuated by under 1 percent. Power at n = 30: |ρ| ≥ 0.36 is detectable; within the 17 arenas 0.49 and the 13 campaign maps 0.56. [memo §3]
...
**Distances have also lost.** Guillory et al. (ICCV 2021) find that Fréchet distance, MMD and proxy A-distance predict accuracy worse than average confidence; Mayilvahanan et al. (ICLR 2024) find that matching train-test similarity leaves CLIP's out-of-distribution performance high. These are the precedents for reporting a weak coefficient. [lit Q1]
